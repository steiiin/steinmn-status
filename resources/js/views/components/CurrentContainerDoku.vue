<template>
  <div class="container-status-row">
    <div class="overall">
      ...
      <span class="label-large">DOKUMENTE {{ state.ok ? 'aktiv' : 'gestört' }}.</span>
    </div>
    <div class="parts">
      <div class="sub-con">
        <StatusIndicator :state="stateColor(state.pl_db)" size="small" />
        <span class="label-small">Datenbank</span>
      </div>
      <div class="sub-con">
        <StatusIndicator :state="stateColor(state.pl_redis)" size="small" />
        <span class="label-small">Redis</span>
      </div>
      <div class="sub-con">
        <StatusIndicator :state="stateColor(state.pl_base)" size="small" />
        <span class="label-small">Container</span>
      </div>
      <div class="sub-con">
        <StatusIndicator :state="stateColor(state.paperless)" size="small" />
